...
<nav id="navigation">
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<!-- Product main img -->
							<?php
								$k = mysqli_query($koneksi, "SELECT * FROM produk WHERE id = '".$_GET['id']."'");
								while($row = mysqli_fetch_array($k)){
							?>
					<div class="col-md-5 ">
						<div id="product-main-img">
							<div class="product-preview">
								<img src="./foto/<?php echo $row['image'] ?>" alt="" width="450px">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
		...
		<a href="https://api.whatsapp.com/send?phone=6285157497110&text=Hallo%20Saya%20ingin%20memesan%20jasa%20desain%20web" target="_blank">
                                <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Pesan</button>
